...
var GameManager = /** @class */ (function () {
    function GameManager() {
        ...
        this.loaderFinished = function () {
            ...
            _this.pixiApp.ticker.add(_this.updateScheduler.tick);
            //Load Map
...
var Inventory = /** @class */ (function () {
    function Inventory() {
        ...
        this.tnt_pumpkin = 0;
        this.tomato_plant = _Balancing__WEBPACK_IMPORTED_MODULE_0__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_1__["ITEM"].TOMATO_PLANT].startSeeds;
        this.pumpkin_plant = _Balancing__WEBPACK_IMPORTED_MODULE_0__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_1__["ITEM"].PUMPKIN_PLANT].startSeeds;
        this.wall = 0;
    }
...
var Player = /** @class */ (function () {
    function Player(x, y, map, playerId) {
        ...
        _index__WEBPACK_IMPORTED_MODULE_1__["gameManager"].updateScheduler.subscribeToTicker("player" + playerId, this.doStep);
    }
...
var PumpkinPlant = /** @class */ (function (_super) {
    ...
    function PumpkinPlant(mother) {
        ...
        _this.crops = _Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].PUMPKIN_PLANT].crops;
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, _UpdateScheduler__WEBPACK_IMPORTED_MODULE_3__["UpdateScheduler"].wait(_Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].PUMPKIN_PLANT].growStepTime)];
                    case 2:
                        _a.sent();
...
var TileObject = /** @class */ (function (_super) {
    ...
    function TileObject(texture, mother, solid) {
        ...
        if (solid) {
            _this.tint = 0xAAAAAA;
            _index__WEBPACK_IMPORTED_MODULE_1__["gameManager"].updateScheduler.subscribeToTicker("wait_to_become_solid_" + _this.mother.gridX + "_" + _this.mother.gridY, _this.tryToBecomeSolid);
        }
        return _this;
    }
...
/* harmony import */ var _Items__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Items */ "./src/model/Items.ts");
/* harmony import */ var _TileObject__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TileObject */ "./src/model/TileObject.ts");
...
var TntPumpkin = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, tilesAround_1 = tilesAround; _i < tilesAround_1.length; _i++) {
                            ...
                            tile.onHit(new _HitEvent__WEBPACK_IMPORTED_MODULE_3__["HitEvent"](hitEvent.initiator, _Balancing__WEBPACK_IMPORTED_MODULE_1__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].TNT_PUMPKIN].explosionDamage));
                        }
                        //Explode!!!
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        frame = frames_1[_i];
                        this.texture = frame;
                        return [4 /*yield*/, _UpdateScheduler__WEBPACK_IMPORTED_MODULE_6__["UpdateScheduler"].wait(50)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
    ...
    return TntPumpkin;
}(_TileObject__WEBPACK_IMPORTED_MODULE_5__["TileObject"]));
...
var TomatoPlant = /** @class */ (function (_super) {
    ...
    function TomatoPlant(mother) {
        ...
        _this.crops = _Balancing__WEBPACK_IMPORTED_MODULE_3__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].TOMATO_PLANT].crops;
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, _UpdateScheduler__WEBPACK_IMPORTED_MODULE_2__["UpdateScheduler"].wait(_Balancing__WEBPACK_IMPORTED_MODULE_3__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].TOMATO_PLANT].growStepTime)];
                    case 2:
                        _a.sent();
...
/* harmony import */ var _Items__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Items */ "./src/model/Items.ts");
/* harmony import */ var _Player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Player */ "./src/model/Player.ts");
/* harmony import */ var _UpdateScheduler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./UpdateScheduler */ "./src/model/UpdateScheduler.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var TomatoProjectile = /** @class */ (function (_super) {
    ...
    function TomatoProjectile(x, y, direction, initiator, owner) {
        ...
        switch (direction) {
            case _Player__WEBPACK_IMPORTED_MODULE_6__["DIRECTION"].UP:
                _this.vy = -1 * _Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_5__["ITEM"].TOMATO_PROJECTILE].speed;
                break;
            case _Player__WEBPACK_IMPORTED_MODULE_6__["DIRECTION"].DOWN:
                _this.vy = 1 * _Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_5__["ITEM"].TOMATO_PROJECTILE].speed;
                break;
            case _Player__WEBPACK_IMPORTED_MODULE_6__["DIRECTION"].LEFT:
                _this.vx = -1 * _Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_5__["ITEM"].TOMATO_PROJECTILE].speed;
                break;
            case _Player__WEBPACK_IMPORTED_MODULE_6__["DIRECTION"].RIGHT:
                _this.vx = 1 * _Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_5__["ITEM"].TOMATO_PROJECTILE].speed;
                break;
        }
        for (var i = 0; i < 6; i++) {
        ...
        _index__WEBPACK_IMPORTED_MODULE_1__["gameManager"].updateScheduler.subscribeToTicker(_this.id, _this.doStep);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _index__WEBPACK_IMPORTED_MODULE_1__["gameManager"].updateScheduler.unsubscribeFromTicker(this.id);
                        TomatoProjectile.smashSound.play(); //Play Smash sound
                        //Trigger Hit event on hitten tile or Player
                        if (collider) {
                            collider.onHit(new _HitEvent__WEBPACK_IMPORTED_MODULE_4__["HitEvent"](this.owner, _Balancing__WEBPACK_IMPORTED_MODULE_2__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_5__["ITEM"].TOMATO_PROJECTILE].hitDamage));
                        }
                    ...
                    case 1:
                        ...
                        frame = _a[_i];
                        this.texture = frame;
                        return [4 /*yield*/, _UpdateScheduler__WEBPACK_IMPORTED_MODULE_7__["UpdateScheduler"].wait(40)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
...
var UpdateScheduler = /** @class */ (function () {
    function UpdateScheduler() {
        ...
        this.tick = function (delta) {
            _this.trigger(UpdateScheduler.TICKER, delta);
        };
    }
     ...
     * @param callback
     */
    UpdateScheduler.prototype.subscribeToTicker = function (subscriberId, callback) {
        this.subscribe(UpdateScheduler.TICKER, subscriberId, callback);
    };
    UpdateScheduler.prototype.unsubscribeFromTicker = function (subscriberId) {
     ...
     */
    UpdateScheduler.prototype.subscribe = function (eventName, subscriberId, callback) {
    ...
    */
    UpdateScheduler.prototype.unsubscribe = function (eventName, subscriberId) {
        if (!this.events[eventName]) {
            throw new Error("Can't unsubscribe \"" + subscriberId + "\" from not existing event: \"" + eventName + "\"");
        }
...
var Wall = /** @class */ (function (_super) {
    ...
    function Wall(mother) {
        ...
        _this.health = _Balancing__WEBPACK_IMPORTED_MODULE_3__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].WALL].defaultHealth;
        _this.statusBar = new _StatusBar__WEBPACK_IMPORTED_MODULE_1__["StatusBar"](_this, false);
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        this.vulnerable = false;
                        this.statusBar.visible = true;
                        this.statusBar.setProgress(this.health / _Balancing__WEBPACK_IMPORTED_MODULE_3__["Balancing"][_Items__WEBPACK_IMPORTED_MODULE_4__["ITEM"].WALL].defaultHealth);
...
var PlayerMenu = /** @class */ (function (_super) {
    ...
    function PlayerMenu(player, width, x) {
        ...
        _index__WEBPACK_IMPORTED_MODULE_1__["gameManager"].updateScheduler.subscribeToTicker("playerMenu" + player.playerId, _this.doStep);
        return _this;
    }
