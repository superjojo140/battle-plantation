class TiledMap extends PIXI.Container {
    ...
    getMapObjectProperty(mapObject, name) {
    ...
    static loadMap(mapPath, spritesheet, callback) {
        const map = new TiledMap();
        //Load Spritesheet
        let SPRITE_SCALE = new PIXI.Point(TiledMap.MAP_ZOOM, TiledMap.MAP_ZOOM);
                    ...
                    for (const co of tl.objects) {
                        ...
                        */
                        if (co.type == "player") {
                            ...
                            const playerId = map.getMapObjectProperty(co, "playerId");
    ...
    getObjectCoordinates(mapObject) {
    ...
    getTileNearestTo(mapObject) {
        const pos = this.getObjectCoordinates(mapObject);
        return this.tiles[pos.gridY][pos.gridX];
    }
}
TiledMap.MAP_ZOOM = 4;
TiledMap.SPRITE_SCALE = new PIXI.Point(TiledMap.MAP_ZOOM, TiledMap.MAP_ZOOM);
